Contributing to CARI Core
============================

The CARI Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Carbon-Reduction-Initiative/CARI/blob/master/doc/translation_process.md)
...
The following applies to code changes to the CARI Core project, and is not to be
confused with overall CARI Network Protocol consensus changes.

Whether a pull request is merged into CARI Core rests with the project merge
...
Patches that change CARI consensus rules are considerably more involved than
...
Where a patchset proposes to change the CARI consensus, it must have been
...
The project leader is the release manager for each CARI Core release.
