...
- Anonymized transactions & consensus using the [_Zerocoin Protocol_](http://www.cri.eco/zpiv) and [zPoS](https://cri.eco/zpos/).
...
More information at [cri.eco](http://www.cri.eco). Join the community at [PIVX Discord](https://discord.gg/m9CwKFp).
