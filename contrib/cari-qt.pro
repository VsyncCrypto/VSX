...
RESOURCES += src/qt/cari.qrc src/qt/cari_locale.qrc

TRANSLATIONS += src/qt/locale/cari_bg.ts \
                src/qt/locale/cari_de.ts \
                src/qt/locale/cari_en.ts \
                src/qt/locale/cari_es.ts \
                src/qt/locale/cari_fi.ts \
                src/qt/locale/cari_fr.ts \
                src/qt/locale/cari_it.ts \
                src/qt/locale/cari_ja.ts \
                src/qt/locale/cari_pl.ts \
                src/qt/locale/cari_pt.ts \
                src/qt/locale/cari_ru.ts \
                src/qt/locale/cari_sk.ts \
                src/qt/locale/cari_sv.ts \
                src/qt/locale/cari_vi.ts \
                src/qt/locale/cari_zh_CN.ts \
                src/qt/locale/cari_zh_TW.ts
