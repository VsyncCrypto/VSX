...
Provides utilities for managing copyright headers of `The VSYNC
...
---------------------------------------------------------
Updates all the copyright headers of `The VSYNC developers` which were
changed in a year more recent than is listed. For example:
```
// Copyright (c) <firstYear>-<lastYear> The VSYNC developers
```
will be updated to:
```
// Copyright (c) <firstYear>-<lastModifiedYear> The VSYNC developers
```
...
those cases:
```
// Copyright (c) <year> The VSYNC developers
```
will be updated to:
```
// Copyright (c) <year>-<lastModifiedYear> The VSYNC developers
```
where the update is appropriate.

copyright\_header.py insert \<file\>
------------------------------------
Inserts a copyright header for `The VSYNC developers` at the top of the
...
If the file already has a copyright for `The VSYNC developers`, the
script will exit.
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_vsync: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_vsync: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_vsync: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_vsync: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
