...
cari.conf           | contains configuration settings for carid or cari-qt
carid.pid           | stores the process id of carid while running
...
debug.log           | contains debug information and general logging generated by carid or cari-qt
