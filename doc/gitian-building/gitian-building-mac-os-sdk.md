...
The script [extract-osx-sdk.sh](https://github.com/Carbon-Reduction-Initiative/VSYNC/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
vsync/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Carbon-Reduction-Initiative/VSYNC/blob/master/doc/README_osx.md) for troubleshooting tips.