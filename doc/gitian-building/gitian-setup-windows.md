...
The build script we'll be using is contained in the CARI github repository ([contrib/gitian-build.py](https://github.com/Carbon-Reduction-Initiative/CARI/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the CARI repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/CARI-Project/CARI/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, cari-detached-sigs, and cari GitHub repos.
