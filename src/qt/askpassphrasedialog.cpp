...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            VSYNCGUI* window = static_cast<VSYNCGUI*>(parentWidget());
...
{
    VSYNCGUI* gui = static_cast<VSYNCGUI*>(parentWidget());
...
{
    hide();
    static_cast<VSYNCGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("VSYNC will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your VSYNCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
