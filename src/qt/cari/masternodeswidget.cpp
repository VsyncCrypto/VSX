...
#include "qt/cari/forms/ui_masternodeswidget.h"

#include "qt/cari/qtutils.h"
#include "qt/cari/mnrow.h"
#include "qt/cari/mninfodialog.h"
#include "qt/cari/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(CARIGUI *parent) :
    PWidget(parent),
