...
#include "qt/cari/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(CARIGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("CARI_tx_csv_export(*.csv)") : tr("CARI_addresses_csv_export(*.csv)"),
                                        nullptr);
