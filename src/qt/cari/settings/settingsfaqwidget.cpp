...
#include "qt/cari/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/cari/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(CARIGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableCARI,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableCARI,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableCARI,
    ...
    connect(ui->pushButton_UnspendableCARI, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableCARI);});
    ...
    if (parent)
        connect(parent, &CARIGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
