...
#include "qt/cari/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cari/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CARIGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CARIGUI::handleRestart()
