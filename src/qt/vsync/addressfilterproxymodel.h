...
#ifndef VSYNC_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define VSYNC_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //VSYNC_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
