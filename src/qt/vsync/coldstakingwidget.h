...
#include "qt/vsync/sendmultirow.h"
#include "qt/vsync/coldstakingmodel.h"
#include "qt/vsync/contactsdropdown.h"
#include "qt/vsync/addressholder.h"
...
public:
    explicit ColdStakingWidget(VSYNCGUI* parent);
    ~ColdStakingWidget();
