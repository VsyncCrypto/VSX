...
#include "qt/vsync/furabstractlistitemdelegate.h"
#include "qt/vsync/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/vsync/txviewholder.h"
...
#include "config/vsync-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalVsync = 0;
    qint64 totalZvsync = 0;
    QList<qreal> valuesVsync;
    QList<qreal> valueszVsx;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(VSYNCGUI* _window);
    ~DashboardWidget();
