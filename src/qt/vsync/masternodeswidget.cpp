...
#include "qt/vsync/forms/ui_masternodeswidget.h"

#include "qt/vsync/qtutils.h"
#include "qt/vsync/mnrow.h"
#include "qt/vsync/mninfodialog.h"
#include "qt/vsync/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(VSYNCGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * GetCollateral())) {
        inform(tr("Not enough balance to create a masternode, 100,000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
