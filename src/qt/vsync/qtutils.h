...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, VSYNCGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, VSYNCGUI* gui, double posX = 3);
