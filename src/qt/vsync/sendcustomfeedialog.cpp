...
#include "qt/vsync/sendcustomfeedialog.h"
#include "qt/vsync/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(VSYNCGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &VSYNCGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
