...
#include "qt/vsync/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/vsync/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(VSYNCGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the VSYNC RPC console.") + "<br>" +
