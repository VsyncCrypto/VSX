...
#include "qt/vsync/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(VSYNCGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("VSYNC_tx_csv_export(*.csv)") : tr("VSYNC_addresses_csv_export(*.csv)"),
                                        nullptr);
