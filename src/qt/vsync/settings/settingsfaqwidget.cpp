...
#include "qt/vsync/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/vsync/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(VSYNCGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableVSYNC,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableVSYNC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableVSYNC,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableVSYNC,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableVSYNC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableVSYNC);});
    ...
    if (parent)
        connect(parent, &VSYNCGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
