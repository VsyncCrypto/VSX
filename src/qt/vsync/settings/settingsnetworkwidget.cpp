...
#include "qt/vsync/settings/settingsnetworkwidget.h"
#include "qt/vsync/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/vsync/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(VSYNCGUI* _window, QWidget *parent) :
