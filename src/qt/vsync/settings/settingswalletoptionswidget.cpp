...
#include "qt/vsync/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/vsync/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(VSYNCGUI* _window, QWidget *parent) :
