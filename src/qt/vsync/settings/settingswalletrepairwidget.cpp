...
#include "qt/vsync/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/vsync/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(VSYNCGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to VSYNCGUI::handleRestart()
