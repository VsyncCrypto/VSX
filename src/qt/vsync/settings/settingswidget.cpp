...
#include "qt/vsync/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(VSYNCGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &VSYNCGUI::openFAQ);
