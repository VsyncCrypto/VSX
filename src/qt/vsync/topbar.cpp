...
#include "qt/vsync/topbar.h"
#include "qt/vsync/forms/ui_topbar.h"
#include "qt/vsync/lockunlock.h"
#include "qt/vsync/qtutils.h"
#include "qt/vsync/receivedialog.h"
#include "qt/vsync/loadingdialog.h"
...
TopBar::TopBar(VSYNCGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopVsync}, "amount-small-topbar");
    setCssProperty({ui->labelAmountVsync}, "amount-topbar");
    setCssProperty({ui->labelPendingVsync, ui->labelImmatureVsync}, "amount-small-topbar");
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // VSYNC Total
    QString totalVsync = GUIUtil::formatBalance(balance, nDisplayUnit);

    // VSYNC
    // Top
    ui->labelAmountTopVsync->setText(totalVsync);
    // Expanded
    ui->labelAmountVsync->setText(totalVsync);
    ui->labelPendingVsync->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureVsync->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
