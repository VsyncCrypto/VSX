...
#ifndef VSYNC_CORE_NEW_GUI_VSYNCGUI_H
#define VSYNC_CORE_NEW_GUI_VSYNCGUI_H
...
#include "qt/vsync/navmenuwidget.h"
#include "qt/vsync/topbar.h"
#include "qt/vsync/dashboardwidget.h"
#include "qt/vsync/send.h"
#include "qt/vsync/receivewidget.h"
#include "qt/vsync/addresseswidget.h"
#include "qt/vsync/coldstakingwidget.h"
#include "qt/vsync/masternodeswidget.h"
#include "qt/vsync/snackbar.h"
#include "qt/vsync/settings/settingswidget.h"
...
/**
  VSYNC GUI main class. This class represents the main window of the VSYNC UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VSYNCGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VSYNCGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~VSYNCGUI();
...
#endif //VSYNC_CORE_NEW_GUI_VSYNCGUI_H
