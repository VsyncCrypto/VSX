...
extern UniValue setzcariseed(const UniValue& params, bool fHelp);
extern UniValue getzcariseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcari(const UniValue& params, bool fHelp);
extern UniValue dzcaristate(const UniValue& params, bool fHelp);
