...
#ifndef VSYNC_STAKEINPUT_H
#define VSYNC_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZVSYNC() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CVsyncStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZVSYNC() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //VSYNC_STAKEINPUT_H
