...
#ifndef CARI_ZCARIWALLET_H
#define CARI_ZCARIWALLET_H
...
public:
    ...
    void GenerateDeterministicZCARI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCARI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
