...
#ifndef VSYNC_ZVSYNCTRACKER_H
#define VSYNC_ZVSYNCTRACKER_H
...
public:
    CzVSXTracker(CWallet* parent);
    ~CzVSXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzVSXWallet* zVSXWallet = NULL);
