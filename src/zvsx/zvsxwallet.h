...
#ifndef VSYNC_ZVSYNCWALLET_H
#define VSYNC_ZVSYNCWALLET_H
...
public:
    ...
    void GenerateDeterministicZVSYNC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZVSYNC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
