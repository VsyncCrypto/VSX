...
"""Verify that starting vsync with -h works as expected."""
import subprocess

from test_framework.test_framework import VsyncTestFramework
from test_framework.util import assert_equal

class HelpTest(VsyncTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vsync with -? for help text")
        ...
        self.log.info("Start vsync with -version for version information")
