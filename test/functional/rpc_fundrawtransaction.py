...
class RawTransactionsTest(CariTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid cari address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid cari address" in e.error['message'])
