...
class TxnMallTest(VsyncTestFramework):
    ...
    def run_test(self):
        ...
        fund_foo_txid = self.nodes[0].sendtoaddress(node0_address_foo, (1219 * 5))
        fund_foo_tx = self.nodes[0].gettransaction(fund_foo_txid)

        node0_address_bar = self.nodes[0].getnewaddress()
        fund_bar_txid = self.nodes[0].sendtoaddress(node0_address_bar, (29 * 5))
        ...
        # First: use raw transaction API to send 1240 * 5 VSYNC to node1_address,
        # but don't broadcast:
